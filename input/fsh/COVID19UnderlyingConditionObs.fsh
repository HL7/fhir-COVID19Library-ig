...
* component[COVID19UnderlyingMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19UnderlyingMedicalCondition)
...
* component[COVID19UnderlyingCardiovascularMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19UnderlyingCardiovascularMedicalCondition)
...
* component[COVID19UnderlyingNeuroligicMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19UnderlyingNeuroligicMedicalCondition)
...
* component[COVID19UnderlyingImmunocompromisedMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19UnderlyingImmunocompromisedMedicalCondition)
...
* component[COVID19RespiratoryUnderlyingMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19RespiratoryUnderlyingMedicalCondition)
...
* component[COVID19UnderlyingMetabolicMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19UnderlyingMetabolicMedicalCondition)
...
* component[COVID19HemoglobinopathyUnderlyingMedicalCondition].extension[conditionReference].valueReference  only Reference(COVID19HemoglobinopathyUnderlyingMedicalCondition)
...
* component[COVID19RenalUnderlyingMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19RenalUnderlyingMedicalCondition)
...
* component[COVID19ImmuneUnderlyingMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19ImmuneUnderlyingMedicalCondition)
...
* component[COVID19GastrointestinalHepaticUnderlyingMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19GastrointestinalHepaticUnderlyingMedicalCondition)
...
* component[COVID19UncategorizedUnderlyingMedicalCondition].extension[conditionReference].valueReference only Reference(COVID19UncategorizedUnderlyingMedicalCondition)
